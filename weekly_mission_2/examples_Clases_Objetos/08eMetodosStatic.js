...
class staticAmigos {
    static Amigo(){
        return 'Extraño pasar buenos ratos con mis amigos de prepa'
    }
}
console.log(staticAmigos.Amigo); //Devuelve la referencia, descripción
console.log(staticAmigos.Amigo()); //Devuelve el valor